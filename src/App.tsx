...
export const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen lg:h-screen lg:max-h-screen lg:overflow-hidden flex flex-col justify-between bg-[#faf7ee] text-[#1f1614] notebook-container select-none">
      {/* Authentic College Ruled Double Red Margin Line */}
      <div className="college-ruled-margin-line" />

      {/* 3 Authentic Binder Hole Punches on Paper */}
      <div className="binder-hole-1" />
      <div className="binder-hole-2" />
      <div className="binder-hole-3" />

      {/* Ambient Coffee Cup Ring */}
      ...
      {/* Left Spiral Rings & Responsive Navigation */}
      <SketchbookNav activeSection={activeSection} setActiveSection={setActiveSection} />

      {/* Main Content Area */}
      <main className="flex-1 md:pl-36 lg:pl-40 px-4 sm:px-8 max-w-6xl w-full mx-auto flex flex-col justify-center py-4 lg:py-5 pt-14 lg:pt-3 pb-28 lg:pb-3 overflow-y-auto lg:overflow-hidden">
