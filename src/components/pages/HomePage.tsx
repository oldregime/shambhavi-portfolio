...
export const HomePage: React.FC<PageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="h-full flex flex-col justify-between py-2 sm:py-3 space-y-2.5 overflow-hidden">
      ...
      {/* Main Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-7 items-center flex-1 my-auto overflow-hidden">
        ...
        <div className="lg:col-span-7 space-y-2.5">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-0.5">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 rounded-full bg-[#5d8aa8] hover:bg-[#4a728e] text-white font-hand text-base font-bold border-2 border-[#3f2a1e] shadow-xs hover:scale-105 active:scale-95 transition-all"
          ...
          <div className="flex items-center gap-2.5 pt-0.5">
            ...
            <a
              ...
              className="p-1.5 rounded-full bg-[#fffef9] border border-[#3f2a1e] hover:bg-[#ede0ca] transition-transform hover:scale-110 shadow-2xs"
              title="GitHub Profile"
            >
              <GithubIcon className="w-3.5 h-3.5 text-[#2b1f1d]" />
            </a>
            <a
            ...
            >
              <LinkedinIcon className="w-3.5 h-3.5 text-[#5d8aa8]" />
            </a>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 flex justify-center relative">
          <div className="relative transform rotate-2 hover:rotate-0 transition-transform duration-500">
            ...
            <div className="bg-[#fffef9] border-2 border-[#3f2a1e] p-3.5 pb-4 rounded-2xl shadow-lg space-y-1.5 w-[230px] sm:w-[260px]" style={{ filter: 'url(#sketch-wobble)' }}>
