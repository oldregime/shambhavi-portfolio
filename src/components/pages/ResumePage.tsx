      ...
      <div className="p-5 sm:p-6 rounded-3xl bg-[#fffef9] border-2 border-[#3f2a1e] shadow-lg space-y-4 relative flex-1 my-auto flex flex-col justify-between" style={{ filter: 'url(#sketch-wobble)' }}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#ede0ca] pb-3">
          <div>
            ...
            <p className="font-hand text-lg font-bold text-[#5d8aa8]">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-[#e8b042] hover:bg-[#d89f33] text-[#1a110e] font-hand text-base sm:text-lg font-bold border-2 border-[#3f2a1e] shadow-sm hover:scale-105 active:scale-95 transition-all"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 font-sans">
          <div className="p-3.5 rounded-xl bg-[#f5ebd9] border border-[#d9cca8] space-y-1">
            <h4 className="font-hand text-lg font-bold text-[#5d8aa8]">🎓 Education</h4>
            <p className="text-xs font-bold text-[#1a110e]">B.Tech CSE (2022–2026)</p>
            <p className="text-[11px] text-[#6a524a]">VIT Bhopal (CGPA: 8.32)</p>
          </div>

          <div className="p-3.5 rounded-xl bg-[#f5ebd9] border border-[#d9cca8] space-y-1">
            <h4 className="font-hand text-lg font-bold text-[#d96b52]">💼 Experience</h4>
          ...
          <div className="p-3.5 rounded-xl bg-[#f5ebd9] border border-[#d9cca8] space-y-1">
            <h4 className="font-hand text-lg font-bold text-[#7a9a7b]">📜 Key Certifications</h4>
        ...
        <div className="p-3 rounded-xl bg-[#edf7ed] border border-[#7a9a7b]/40 font-hand text-base text-[#2b1f1d] flex items-center gap-2">
          <Sparkles className="w-4 h-4 text-[#7a9a7b] shrink-0" />
          <span>Available for full-time Data Engineering, Cloud Infrastructure, and AI roles starting 2026.</span>
        </div>
      </div>
